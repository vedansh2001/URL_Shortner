...
function Analytics() {
    ...
    return (
        <>
        <div className='bg-[#1E201E] w-full h-screen font-mono flex justify-center pt-24'>
         <div className='w-3/5'>
           <h1 className='text-white text-5xl font-bold flex justify-center pb-8'>
             ANALYTICS
           </h1>
          <div className='bg-[#40534C] w-full h-[70%] rounded-md '>
            <h1 className='pt-7 pb-5 text-3xl font-semibold text-gray-900 ml-[10%]'>
              Total URL clicks
            </h1>
            <p className="mx-[10%] text-xl font-normal text-gray-800 ">
